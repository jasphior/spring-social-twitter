...
/**
 * Interface defining the operations for searching Twitter and retrieving
 * trending data.
 * 
 * @author Craig Walls
 */
public interface SearchOperations {
	...
	/**
	 * Retrieves the top 20 trending topics, hourly for the past 24 hours. This
	 * list includes hashtagged topics.
	 * 
	 * @return a list of Trends objects, one for each hour in the past 24 hours,
	 *         ordered with the most recent hour first.
	 * @throws ApiException
	 *             if there is an error while communicating with Twitter.
	 */
	 ...
	 *            if true, hashtagged topics will be excluded from the trends
	 *            list.
	 * @return a list of Trends objects, one for each hour in the past 24 hours,
	 *         ordered with the most recent hour first.
	 * @throws ApiException
	...
	/**
	 * Retrieves the top 20 trending topics, hourly for a 24-hour period
	 ...
	 *            list.
	 * @param startDate
	 *            the date to start retrieving trending data for, in MM-DD-YYYY
	 *            format.
	 * @return a list of Trends objects, one for each hour in the given 24
	 *         hours, ordered with the most recent hour first.
	 * @throws ApiException
	 *             if there is an error while communicating with Twitter.
	 */
	...
	/**
	 * Retrieves the top 30 trending topics for each day in the past week. This
	 * list includes hashtagged topics.
	 * 
	 * @return a list of Trends objects, one for each day in the past week,
	 *         ordered with the most recent day first.
	 * @throws ApiException
	 *             if there is an error while communicating with Twitter.
	 */
	 ...
	 *            the date to start retrieving trending data for, in MM-DD-YYYY
	 *            format.
	 * @return a list of Trends objects, one for each day in the given week,
	 *         ordered with the most recent day first.
	 * @throws ApiException
	 *             if there is an error while communicating with Twitter.
	 */
	...
	/**
	 * Retrieves the top 10 trending topics for a given location, identified by
	 * its "Where on Earth" (WOE) ID. This includes hashtagged topics. See
	 * http://developer.yahoo.com/geo/geoplanet/guide/concepts.html for more
	 * information on WOE.
	 * 
	 ...
	 *            if true, hashtagged topics will be excluded from the trends
	 *            list.
	 * @return A Trends object with the top 10 trending topics for the given
	 *         location.
	 * @throws ApiException
	 *             if there is an error while communicating with Twitter.
	 */
